...
books = pd.read_csv('C:/2-dataset/book.csv')
books
books.columns
'''
...
#now let us separate out each item from the books list
...
#in order to generate association rules you can directly use books_list
#now let separate out each item from the boks_list
...
#we had extra row created, check the books_series
...
#books series has column having name 0  to all
#books series has column having name 0 let us rename as transactions
...
#this generate association rules
